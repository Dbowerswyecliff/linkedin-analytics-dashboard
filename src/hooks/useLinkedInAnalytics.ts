...
const LINKEDIN_AUTH_URL = IS_DEMO_MODE ? '' : (import.meta.env.VITE_LINKEDIN_AUTH_FUNCTION_URL || '');
const LINKEDIN_SYNC_URL = IS_DEMO_MODE ? '' : (import.meta.env.VITE_LINKEDIN_SYNC_URL || '');
